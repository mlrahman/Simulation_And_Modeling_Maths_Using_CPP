...
int main()
{
    ...
    ll month,n,m,data,s,S,inventory,h_cost,ba_cost;
    cin>>inventory;
    cin>>s>>S;
    cin>>n;
    ...
    ll i=1;
    ll index=0,month_count=0,oa=0,oa_index=0,os=0;
    while(true)
    {
        if(index>=n) break;
    ...
    cout<<"Time Average no of items in Negative Inventory, I- = "<<fixed<<setprecision(3)<<III<<" Per Month"<<endl<<endl;
    cout<<"Total Holding Cost, H = "<<H<<" Taka"<<endl<<endl;
    cout<<"Total Backlog Cost, B = "<<Ba<<" Taka"<<endl<<endl;
